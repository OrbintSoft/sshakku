...
// newKeychainBackend returns a wallet.Backend over the macOS keychain, scoped to
...
func newKeychainBackend(user string, timeout time.Duration, prefix string) wallet.Backend {
