...
func TestAddWithAskpassRealBinaryDarwin(t *testing.T) {
	...
	const passphrase = "sshakku-darwin-handoff-test-passphrase" //nolint:gosec // G101 is right that this is a passphrase: the one this test invents for a key it invents
