...
// Bitwarden's own Unlock/Lock — including the master-password prompt
...
// on (see the design note on Bitwarden), so this test needs the
...
// TestBitwardenBackendRealAccount exercises Bitwarden end to end
