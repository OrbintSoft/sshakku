...
func TestKeychainGivesUpOnAKeychainThatNeverAnswers(t *testing.T) {
	ops := []struct {
		name string
		call func(*Keychain) error
	}{
		{"Lookup", func(b *Keychain) error { _, _, err := b.Lookup(t.Context(), "svc"); return err }},
		{"Store", func(b *Keychain) error { return b.Store(t.Context(), "svc", "a key", "hunter2") }},
		{"Delete", func(b *Keychain) error { return b.Delete(t.Context(), "svc") }},
		{"List", func(b *Keychain) error { _, err := b.List(t.Context()); return err }},
	}
	for _, op := range ops {
